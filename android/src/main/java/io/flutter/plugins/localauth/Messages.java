...
public class Messages {
  ...
  public static final class AuthOptions {
    ...
    private @NonNull Boolean strongMode;

    public @NonNull Boolean getStrongMode() {
      return strongMode;
    }

    public void setStrongMode(@NonNull Boolean setterArg) {
      if (setterArg == null) {
        throw new IllegalStateException("Nonnull field \"strongMode\" is null.");
      }
      this.strongMode = setterArg;
    }
    ...
    public static final class Builder {
      ...
      private @Nullable Boolean strongMode;

      public @NonNull Builder setStrongMode(@NonNull Boolean setterArg) {
        this.strongMode = setterArg;
        return this;
      }
      ...
      public @NonNull AuthOptions build() {
        ...
        pigeonReturn.setStrongMode(strongMode);
    ...
    static @NonNull AuthOptions fromList(@NonNull ArrayList<Object> list) {
      ...
      Object strongMode = list.get(1);
      pigeonResult.setStrongMode((Boolean) strongMode);
      Object sensitiveTransaction = list.get(2);
      pigeonResult.setSensitiveTransaction((Boolean) sensitiveTransaction);
      Object sticky = list.get(3);
      pigeonResult.setSticky((Boolean) sticky);
      Object useErrorDialgs = list.get(4);
